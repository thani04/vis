...
# กำหนดโทนสีแบบจับคู่
COLOR_GROUP1 = "#E0FFFF"   # สีอ่อนนวลสำหรับ Section 1 & 2
COLOR_GROUP2 = "#fff3e0"   # สีเขียวอ่อนสำหรับ Section 3 & 4
...
st.markdown(f"""
<div style="background-color: #fff3e0; padding: 15px; border-left: 5px solid #388e3c; margin-top: 10px;">
    <ul>
