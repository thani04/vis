...
with st.sidebar:
    ...
    <div style="background-color:#f7f7f7; padding:10px; border-radius:8px;">
        ...
        <ol style="margin-left: -10px;">
            <li>What Captures Attention?</li>
            <li>How Do We Measure Focus?</li>
            <li>Focus-Concentration Score</li>
            <li>Visual Examples of Focus</li>
            <li>Focus-Concentration Visualization</li>
        </ol>
    </div>
...
# ----------------------------
# SECTION 5: Focus-Concentration Visualization
# ----------------------------
st.markdown("## 📈 Focus-Concentration Visualization")
