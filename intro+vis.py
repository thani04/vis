...
section = st.sidebar.radio("Jump to Section", [
    "1. What Captures Attention?",
    "2. How Do We Measure Focus?",
    "3. Focus-Concentration (F-C) Score",
    "4. Visual Examples of Focus",
    "5. Focus-Concentration Visualization"
])
...
# SECTION 1
# ----------------------------
if section == "1. What Captures Attention?":
...
# SECTION 2
# ----------------------------
elif section == "2. How Do We Measure Focus?":
    st.markdown(f"""
    <div style="background-color: {COLOR_GROUP1}; padding: 20px; border-radius: 10px;">
...
# SECTION 3
# ----------------------------
elif section == "3. Focus-Concentration (F-C) Score":
    st.markdown(f"""
...
# SECTION 4
# ----------------------------
elif section == "4. Visual Examples of Focus":
    st.markdown(f"""
    <div style="background-color: {COLOR_GROUP2}; padding: 20px; border-radius: 10px;">
...
# ----------------------------
# SECTION 5: Placeholder for Graph/Video Analytics
# ----------------------------
elif section == "5. Focus-Concentration Visualization":
    st.markdown("## 📊 Stay Focused or Float Away? : Focus-Concentration Visualization")
    st.write("(Insert your graph/video analytics part here)")
