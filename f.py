...
# Sidebar navigation
page = st.sidebar.radio("Navigation", ["📊 Gaze Analysis (Interactive)", "📖 F-C Score Explanation"])
...
# --------------- PAGE 1: MAIN GAZE ANALYSIS ----------------
if page == "📊 Gaze Analysis (Interactive)":
...
# --------------- PAGE 2: FC SCORE EXPLANATION ----------------
elif page == "📖 F-C Score Explanation":
    st.title("📖 Understanding the Focus-Concentration (F-C) Score")
